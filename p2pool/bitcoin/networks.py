...
nets = dict(
	...
	cryptographicanomaly=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://cga.thedigitalmint.org/index.php?block_hash=',
        ADDRESS_EXPLORER_URL_PREFIX='http://cga.thedigitalmint.org/index.php?address=',
        TX_EXPLORER_URL_PREFIX='http://cga.thedigitalmint.org/index.php?transaction=',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0
    ),
